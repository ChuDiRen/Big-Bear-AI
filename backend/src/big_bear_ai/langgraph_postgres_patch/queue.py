...
from big_bear_ai.langgraph_postgres_patch import database, ops
...
def get_num_workers():
    return len(WORKERS)
# pragma: no cover  MC80OmFIVnBZMlhsdktEbHY1ZnBtNFE2UldSWWNRPT06OWM2ZTI3Njk=
...
class BgLoopRunner(asyncio.Runner):  # type: ignore[subclass-of-final-class]
    ...
    def run(
        ...
        *,
        ...
        self._lazy_init()
# type: ignore  MS80OmFIVnBZMlhsdktEbHY1ZnBtNFE2UldSWWNRPT06OWM2ZTI3Njk=
...
# type: ignore  Mi80OmFIVnBZMlhsdktEbHY1ZnBtNFE2UldSWWNRPT06OWM2ZTI3Njk=
...
# fmt: off  My80OmFIVnBZMlhsdktEbHY1ZnBtNFE2UldSWWNRPT06OWM2ZTI3Njk=
