...
# fmt: off  MC80OmFIVnBZMlhsdktEbHY1ZnBtNFE2UjA1bGF3PT06MzlkYmJmNzg=
...
# pragma: no cover  MS80OmFIVnBZMlhsdktEbHY1ZnBtNFE2UjA1bGF3PT06MzlkYmJmNzg=
...
# fmt: off  Mi80OmFIVnBZMlhsdktEbHY1ZnBtNFE2UjA1bGF3PT06MzlkYmJmNzg=
...
async def get_pubsub(
    *, channels: list[str] | None = None, patterns: list[str] | None = None
    ...
    return pubsub
# pragma: no cover  My80OmFIVnBZMlhsdktEbHY1ZnBtNFE2UjA1bGF3PT06MzlkYmJmNzg=
...
# Stream to cache all run events for a thread.
STREAM_THREAD_CACHE = f"{REDIS_KEY_PREFIX}thread:{THREAD_ID_SEGMENT}:cache"
# Channel for control run events. It avoids scanning all run stream events for cancellation.
